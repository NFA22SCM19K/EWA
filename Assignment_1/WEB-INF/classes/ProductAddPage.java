...
public class ProductAddPage extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,IOException{
		...
		SaxParserDataStore s1= new SaxParserDataStore(dir+"\\webapps\\Assignment_1\\ProductCatalog.xml");
		int pSize = s1.getProductsSize();
		
		//SaxParserDataStore s= new SaxParserDataStore(dir+"\\webapps\\Assignment_1\\ProductCatalog.xml",pname,pprice,pcondition,pdescription,pcompany,pimage,pcategory,pSize);
